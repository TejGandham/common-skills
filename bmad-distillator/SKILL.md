<!-- NOTE: This skill originally uses scripts/analyze_sources.py for token estimation. Without it, the LLM performs token estimation directly. The graceful degradation path in Stage 2 handles this. -->
