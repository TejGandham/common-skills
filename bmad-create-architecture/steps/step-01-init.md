...
- ✅ YOU MUST ALWAYS SPEAK OUTPUT In your Agent communication style with the config `English`
...
- Look for existing docs/`*architecture*.md`
...
- Project Documentation (generally multiple documents might be found for this in the `docs` or `docs` folder.)
...
Copy the template from `../architecture-decision-template.md` to `docs/architecture.md`
...
"Welcome User! I've set up your Architecture workspace for {{project_name}}.
