...
After each section is refined, append it to the output document at `docs/prfaq-bmad-eval.md`. Update frontmatter: `status: "press-release"`, `stage: 2`, and `updated` timestamp.
