**Language:** Use `English` for all output.
**Output Language:** Use `English` for documents.
...
**Always produce the distillate** at `docs/prfaq-bmad-eval-distillate.md`:

```yaml
---
title: "PRFAQ Distillate: bmad-eval"
type: llm-distillate
source: "prfaq-bmad-eval.md"
created: "{timestamp}"
...
"Your PRFAQ for bmad-eval has survived the gauntlet.

**PRFAQ:** `docs/prfaq-bmad-eval.md`
**Detail Pack:** `docs/prfaq-bmad-eval-distillate.md`
...
```json
{
  "status": "complete",
  "prfaq": "docs/prfaq-bmad-eval.md",
  "distillate": "docs/prfaq-bmad-eval-distillate.md",
