...
- Look for file at `docs/project-context.md` or `**/project-context.md`
...
- Look for `docs/architecture.md` or `**/architecture.md`
...
Copy template from `../project-context-template.md` to `docs/project-context.md`
...
"Welcome User! I've analyzed your project for {{project_name}} to discover the context that AI agents need.
