...
Config: user_name=User, communication_language=English, document_output_language=English, planning_artifacts=docs, implementation_artifacts=docs/implementation, user_skill_level=expert, project_name=project
