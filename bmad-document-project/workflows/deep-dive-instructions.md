...
<action>Write filled template to: docs/deep-dive-{{sanitized_target_name}}.md</action>
...
**Generated:** docs/deep-dive-{{target_name}}.md
...
**Index Updated:** docs/index.md now includes link to this deep-dive
